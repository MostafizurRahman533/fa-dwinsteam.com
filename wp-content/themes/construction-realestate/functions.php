...
if ( ! function_exists( 'construction_realestate_credit' ) ) {
	function construction_realestate_credit(){
		echo "<a href=".esc_url(CONSTRUCTION_REALESTATE_CREDIT)." target='_blank' alt='".esc_html__('Construction WordPress Theme','construction-realestate')."''>".esc_html__('Construction WordPress Theme','construction-realestate')."</a>";
	}
}
